...
### Wins
* Teamwork: This was our first experience with pair-coding which was a real adjustment  in terms of how I was used to troubleshooting.  We had great communication so were able to adapt the pace to each others needs as and when it was required.
...
* Refactoring: I was very pleased with how we kept the code simple and easy to read, by organising it into a few smaller components. 
...
* The importance of pseudocode and annotation throughout this project helped keep things clear and organised

### Future features
* I would like to be able to add a button for generating a random word from one of the dictionaries, which again returns the two definitions from the API. 
